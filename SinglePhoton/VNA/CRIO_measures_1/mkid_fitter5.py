...
if __name__ == "__main__":
    ...
    data_big = pd.read_csv("CRIO_measures/picco6_big.csv")  # Replace with actual big file name
    mask = (data_big["frequency"] >= 8.6324e9)
    ...
    data_small = pd.read_csv("CRIO_measures/picco6_small.csv") # Replace with actual small file name
    mask = (data_small["frequency"] >= 8.6324e9)
