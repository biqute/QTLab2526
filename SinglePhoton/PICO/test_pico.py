...
# Forza Python a cercare le DLL nella cartella corrente
...
channelD = ps.PS5000A_CHANNEL["PS5000A_CHANNEL_D"]

status["setChB"] = ps.ps5000aSetChannel(chandle, channelB, 0, coupling_type, chARange, 0)
status["setChC"] = ps.ps5000aSetChannel(chandle, channelC, 0, coupling_type, chARange, 0)
status["setChD"] = ps.ps5000aSetChannel(chandle, channelD, 0, coupling_type, chARange, 0)
...
threshold = int(mV2adc(10,chARange, maxADC))
direction = 2 #PS5000A_RISING = 2
delay = 0 # s
auto_trigger = 1000 # ms
status["trigger"] = ps.ps5000aSetSimpleTrigger(chandle, 1, source, threshold, direction, delay, auto_trigger)
