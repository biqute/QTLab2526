...
# Load synthetic data
# -------------------------------------------------------
data = pd.read_csv(r"C:\Users\kid\labQT\Lab2025\Single photon\QTLab2526\SinglePhoton\S21_hanger100medie_corretto_peak2")

#mask = (data["frequency"] <= 5.7e9) & (data["frequency"] >= 5.3e9)
#data = data[mask]
